...
static inline std::uint_fast16_t get_8(const void* p)
{
    const unsigned char* data = (const unsigned char*)p;
    return data[0];
}
static inline std::uint_fast16_t get_16(const void* p)
{
...
static inline std::uint_fast16_t R16r(const void* p)
{
...
static inline std::uint_fast32_t R24(const void* p)
{
...
static inline std::uint_fast32_t R24r(const void* p)
{
    const unsigned char* data = (const unsigned char*)p;
    return get_16(data+1) | (get_8(data) << UINT32_C(16));
}
static inline std::uint_fast32_t get_32(const void* p)
{
  #ifdef LITTLE_ENDIAN_AND_UNALIGNED_ACCESS_OK
...
static inline std::uint_fast32_t R32r(const void* p)
{
  #ifdef BIG_ENDIAN_AND_UNALIGNED_ACCESS_OK
    return *(const std::uint_least32_t*)p;
  #else
...
#define L (std::uint_fast64_t)

static inline std::uint_fast64_t get_64(const void* p)
{
  #ifdef LITTLE_ENDIAN_AND_UNALIGNED_ACCESS_OK
...
static inline std::uint_fast64_t R64r(const void* p)
{
  #ifdef BIG_ENDIAN_AND_UNALIGNED_ACCESS_OK
    return *(const std::uint_least64_t*)p;
  #else
...
static inline std::uint_fast64_t get_n(const void* p, unsigned bytes)
{
    const unsigned char* data = (const unsigned char*)p;
    ...
    switch(bytes)
    {
        ...
        case 7: res |= ((std::uint_fast64_t)get_8(data+6)) << 48; [[fallthrough]];
        case 6: res |= ((std::uint_fast64_t)get_8(data+5)) << 40; [[fallthrough]];
        case 5: res |= ((std::uint_fast64_t)get_16(data+3)) << 24; [[fallthrough]];
        case 3: res |= ((std::uint_fast64_t)get_16(data+1)) << 8; [[fallthrough]];
        case 1: res |= get_8(data);
    }
    return res;
}

static void put_8(void* p, std::uint_fast8_t value)
{
    unsigned char* data = (unsigned char*)p;
    data[0] = value;
}
static void put_16(void* p, std::uint_fast16_t value)
{
  #ifdef LITTLE_ENDIAN_AND_UNALIGNED_ACCESS_OK
    *(std::uint_least16_t*)p = value;
  #else
    unsigned char* data = (unsigned char*)p;
    put_8(data+0, value   );
...
static void put_32(void* p, std::uint_fast32_t value)
{
  #ifdef LITTLE_ENDIAN_AND_UNALIGNED_ACCESS_OK
    *(std::uint_least32_t*)p = value;
  #else
    unsigned char* data = (unsigned char*)p;
    put_16(data+0, value);
...
static void put_64(void* p, std::uint_fast64_t value)
{
  #ifdef LITTLE_ENDIAN_AND_UNALIGNED_ACCESS_OK
    *(std::uint_least64_t*)p = value;
  #else
    unsigned char* data = (unsigned char*)p;
    put_32(data+0, (value));
...
static inline void put_n(void* p, std::uint_fast64_t value, unsigned bytes)
{
    unsigned char* data = (unsigned char*)p;
    switch(bytes)
    {
